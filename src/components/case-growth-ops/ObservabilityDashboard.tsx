...
/** Simulação visual do dashboard de observabilidade (dados ilustrativos). */
export default function ObservabilityDashboard() {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-surface-line bg-[#0c0e12] shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
      ...
      <p className="border-t border-white/[0.06] px-4 py-2.5 text-[11px] text-muted sm:px-5">
        Simulação ilustrativa da UI de observabilidade. Dados mascarados, sem PII
        operacional.
      </p>
    </div>
  );
