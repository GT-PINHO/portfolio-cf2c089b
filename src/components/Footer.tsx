...
export default function Footer() {
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1180px] flex-col items-center justify-between gap-5 px-6 sm:flex-row sm:px-8">
        ...
        <p className="text-[12px] text-muted order-last sm:order-none">© 2026</p>
