...
const ROLES: Role[] = [
  {
    ...
    current: true,
    bullets: [
      "Meta Ads em operação nacional — budget semanal de R$68k a R$98k, +21 mil leads diretos, CPL R$13.",
      "Rastreamento server-side: GTM, API de Conversão e Stape.",
      "Automações UTM → CRM para o time de inside sales.",
      "Integrações entre campanha, CRM e operação comercial.",
      "Dashboards e sistemas com IA para gestão diária.",
    ],
  },
  {
    ...
    bullets: [
      "Meta Ads para cerca de 40 eventos mensais em todo o Brasil.",
      "+240 mil leads gerados com CPL médio de R$8.",
      "Funil por cidade, testes A/B e escala progressiva de verba.",
      "Lookalikes, remarketing e auditoria de sinal via GTM.",
    ],
  },
];
